    ...
    @foreach($users as $user)
        <tr>
            ...
            <td>
                ...
                @else
                    <img class="image rounded-circle" alt="{{ __('site.picture') }}" src="{{asset('/storage/pictures/profile/'.$user->picture)}}" alt="profile_image" style="width: 100px;height: 100px; padding: 10px; margin: 0px; "/>
                @endif
            </td>
            <td>
